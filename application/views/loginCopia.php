      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
              ...
              <h1>Login Form</h1>
              <div>
			  <input type="email" name="correo" id="correo"placeholder="Ingrese correo" required maxlength="50">
              </div>
              <div>
			  <input type="password" name="clave" id="clave" placeholder="digite clave" required maxlength="255">
              </div>
              <div>
                <button class="btn btn-default submit" type="submit" name="enviar" id="enviar">Iniciar session</button>
